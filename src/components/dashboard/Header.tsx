...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="print:hidden bg-slate-900 border-b border-slate-800 text-slate-100 sticky top-0 z-30 shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="font-semibold text-lg text-white tracking-tight leading-tight">Net Worth Tracker</h1>
            </div>
            ...
            <div className="flex items-center gap-1.5 mt-0.5">
              ...
              <select
                ...
                className="bg-transparent text-xs text-slate-300 font-medium hover:text-white focus:outline-none cursor-pointer max-w-[140px] sm:max-w-[200px] truncate"
              >
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-500 hover:to-teal-500 text-white text-xs font-semibold rounded-lg shadow-sm transition-all shadow-emerald-900/30 active:scale-95"
          >
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 bg-slate-800 hover:bg-slate-700 text-slate-200 text-xs font-medium rounded-lg border border-slate-700 transition-colors"
          ...
          <button
            ...
            className="p-1.5 bg-slate-800 hover:bg-slate-700 text-slate-300 rounded-lg border border-slate-700 transition-colors hidden sm:flex"
            title="App Settings"
          >
