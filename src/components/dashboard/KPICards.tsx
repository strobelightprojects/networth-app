...
export const KPICards: React.FC<KPICardsProps> = ({ portfolio, currency }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 my-6">
      ...
      {/* 1. NET WORTH CARD */}
      <div className="bg-white dark:bg-slate-900/90 backdrop-blur-sm border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm relative overflow-hidden group hover:border-emerald-500/30 transition-all">
        <div className="absolute top-0 right-0 w-24 h-24 bg-emerald-500/10 rounded-full blur-2xl group-hover:bg-emerald-500/20 transition-all" />
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-2">
          <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Total Net Worth</span>
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <span className="text-slate-500 dark:text-slate-400 text-[11px]">vs last month</span>
        </div>
      </div>

      {/* 2. TOTAL ASSETS CARD */}
      <div className="bg-white dark:bg-slate-900/90 backdrop-blur-sm border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm relative overflow-hidden group hover:border-blue-500/30 transition-all">
        <div className="absolute top-0 right-0 w-24 h-24 bg-blue-500/10 rounded-full blur-2xl group-hover:bg-blue-500/20 transition-all" />
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-2">
          <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Total Assets</span>
      ...
      <div className="bg-white dark:bg-slate-900/90 backdrop-blur-sm border border-slate-200 dark:border-slate-800 rounded-2xl p-5 shadow-sm relative overflow-hidden group hover:border-rose-500/30 transition-all">
        ...
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-2">
          <span className="text-xs font-semibold uppercase tracking-wider text-slate-500 dark:text-slate-400">Total Liabilities</span>
        ...
        <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
          <span className="font-semibold text-rose-600 dark:text-rose-400">{leverageRatio.toFixed(1)}% Debt</span>
          <span>•</span>
      ...
      <div className="bg-white dark:bg-slate-900/90 backdrop-blur-sm border border-purple-200 dark:border-purple-500/20 rounded-2xl p-5 shadow-sm relative overflow-hidden group hover:border-purple-500/40 transition-all">
        <div className="absolute top-0 right-0 w-24 h-24 bg-purple-500/10 rounded-full blur-2xl group-hover:bg-purple-500/20 transition-all" />
        <div className="flex items-center justify-between text-slate-500 dark:text-slate-400 mb-2">
          <span className="text-xs font-semibold uppercase tracking-wider text-purple-700 dark:text-purple-300 flex items-center gap-1">
            <Shield className="w-3.5 h-3.5 text-purple-600 dark:text-purple-400" /> Insurance
          </span>
        ...
        <div className="flex items-center justify-between text-xs text-purple-700/80 dark:text-purple-300/80">
          <span className="font-semibold text-purple-600 dark:text-purple-400">{insuranceCount} {insuranceCount === 1 ? 'Policy' : 'Policies'}</span>
          <span className="text-[10px] text-slate-500 dark:text-slate-400 font-medium">Excluded from Net Worth</span>
        </div>
      </div>
